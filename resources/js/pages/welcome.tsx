      ...
      <div className="flex min-h-screen flex-col items-center bg-[#FDFDFC] p-6 text-[#1b1b18] lg:justify-center lg:p-8 dark:bg-[#0a0a0a]">
        ...
        <div className="flex w-full items-center justify-center opacity-100 starting:opacity-0 transition-opacity duration-750 lg:grow">
          <main className="flex w-full max-w-[335px] flex-col-reverse lg:max-w-4xl lg:flex-row">
            ...
            <div className="-mb-px lg:-ml-px relative aspect-[335/376] w-full shrink-0 overflow-hidden rounded-t-lg bg-[#fff2f2] lg:mb-0 lg:aspect-auto lg:w-[438px] lg:rounded-t-none lg:rounded-r-lg dark:bg-[#1D0002]">
              <svg
                aria-hidden="true"
                className="w-full max-w-none starting:translate-y-6 translate-y-0 text-[#F53003] opacity-100 starting:opacity-0 transition-all duration-750 dark:text-[#F61500]"
                fill="none"
                viewBox="0 0 438 104"
                xmlns="http://www.w3.org/2000/svg"
              >
              ...
              <svg
                aria-hidden="true"
                className="-mt-[4.9rem] -ml-8 lg:-mt-[6.6rem] relative w-[448px] max-w-none lg:ml-0 dark:hidden"
                fill="none"
                viewBox="0 0 440 376"
                xmlns="http://www.w3.org/2000/svg"
              >
                ...
                <g
                  className="starting:translate-y-4 translate-y-0 opacity-100 starting:opacity-0 transition-all delay-300 duration-750"
                ...
                <g className="starting:translate-y-4 translate-y-0 opacity-100 starting:opacity-0 mix-blend-plus-darker transition-all delay-300 duration-750">
                  <path
              ...
              <svg
                aria-hidden="true"
                className="-mt-[4.9rem] -ml-8 lg:-mt-[6.6rem] relative hidden w-[448px] max-w-none lg:ml-0 dark:block"
                fill="none"
                viewBox="0 0 440 376"
                xmlns="http://www.w3.org/2000/svg"
              >
