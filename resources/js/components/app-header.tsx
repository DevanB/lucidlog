    ...
    <>
      <div className="border-sidebar-border/80 border-b">
        <div className="mx-auto flex h-16 items-center px-4 md:max-w-7xl">
          ...
          <Link className="flex items-center space-x-2" href={dashboard()} prefetch>
            <AppLogo />
          </Link>
          ...
          <div className="ml-6 hidden h-full items-center space-x-6 lg:flex">
            <NavigationMenu className="flex h-full items-stretch">
              <NavigationMenuList className="flex h-full items-stretch space-x-2">
                {mainNavItems.map((item) => (
                  <NavigationMenuItem className="relative flex h-full items-center" key={String(item.href)}>
                    <Link
                      className={cn(
                        navigationMenuTriggerStyle(),
                    ...
                    <Tooltip>
                      <TooltipTrigger>
                        ...
                        >
                          ...
                          {item.icon && (
                            <Icon className="size-5 opacity-80 group-hover:opacity-100" iconNode={item.icon} />
                          )}
                        </a>
                      </TooltipTrigger>
                      <TooltipContent>
