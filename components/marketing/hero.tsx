...
export function Hero() {
  return (
    <Container className="pt-20 pb-16 text-center lg:pt-24 lg:pb-32">
      <h1 className="mx-auto max-w-4xl font-display text-5xl font-medium tracking-tight text-slate-900 dark:text-slate-200 sm:text-7xl">
        Unlock{' '}
        <span className="relative whitespace-nowrap text-violet-800 dark:text-violet-400">
          <svg
            aria-hidden="true"
            viewBox="0 0 418 42"
            className="absolute top-2/3 left-0 h-[0.58em] w-full fill-violet-400/70 dark:fill-violet-200/70"
          ...
          <span className="relative">the mysteries</span>
        </span>{' '}
        of your dreams.
      </h1>
