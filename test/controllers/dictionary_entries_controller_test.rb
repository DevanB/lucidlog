...
class DictionaryEntriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create dictionary_entry" do
    assert_difference("DictionaryEntry.count") do
      post dictionary_entries_url, params: { dictionary_entry: { definition: @dictionary_entry.definition, draft: @dictionary_entry.draft, term: @dictionary_entry.term } }
    end
  ...
  test "should update dictionary_entry" do
    patch dictionary_entry_url(@dictionary_entry), params: { dictionary_entry: { definition: @dictionary_entry.definition, draft: @dictionary_entry.draft, term: @dictionary_entry.term } }
