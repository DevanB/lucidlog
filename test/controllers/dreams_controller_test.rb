...
class DreamsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create dream" do
    assert_difference("Dream.count") do
      post dreams_url, params: { dream: { body: @dream.body, dream_date: @dream.dream_date, title: @dream.title } }
    end
  ...
  test "should update dream" do
    patch dream_url(@dream), params: { dream: { body: @dream.body, dream_date: @dream.dream_date, title: @dream.title } }
